...
let mockData = dummyToday;
  ...
  for (let i = 0; i< mockData.length; i++){
    ...
    data.push(mockData[i].environmentCost)
    dataweek.push(dummyWeek[i].environmentCost)
    datamonth.push(dummyMonth[i].environmentCost)
    ...
    return (
      <>
        ...
        <Flex justifyContent="space-between" alignItems="center" mb="2">
          <Heading>Environmental Costs</Heading>
          <Select
            width="200px"
          ...
          <Table maxH="500px">
            <Thead>
              <Tr>
                ...
                <Th textAlign="center">Environmental Costs</Th>
              </Tr>
            </Thead>
            <Tbody>
